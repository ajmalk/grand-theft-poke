...
public class GymLeader extends Person {
	...
	public GymLeader(String name, int strength, int agility, int trade, int stamina, int health, int range, int capacity, Float money, GameMap theMap) {
	...
	public void stake(Person other, int stake) {
		if(getWallet().checkAmount(stake) && other.getWallet().checkAmount(stake)) {
