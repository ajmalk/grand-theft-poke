...
public class Main {
    ...
    public static GameMap makeMap(GlobalItemReference theReference) {
        ...
        TownFactoryImplementation townGenerator = new TownFactoryImplementation(theReference);
    ...
    public static void testMarketPlace(GameMap map, GlobalItemReference theReference) {
    ...
    public static void testMovement(GameMap map) {
        ...
        for (Iterator it = townSet.iterator(); it.hasNext();) {
