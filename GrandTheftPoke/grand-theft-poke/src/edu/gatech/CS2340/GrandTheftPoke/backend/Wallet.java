...
/**
 * The wallet keeps track of the person's money and allows for updates 
...
public class Wallet {
	 ...
	 * @param num the amount to be help in the wallet
	 */
 ...
 */
	...
	/**
	 * Adds or subtracts money from the wallet; mostly used for buying
	 * and selling goods or services. 
	 * @param num the amount wanted to be added to wallet
	 */
	...
	/**
	 * Checks if an item or good costs more than your wallet contains;
	 * this determines if you can afford an item.
	 * @param amount the cost of the item or service
